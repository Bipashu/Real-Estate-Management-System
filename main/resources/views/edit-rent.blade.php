...
<div class="text-start">
        <h5 style="color:#E8A87C;">Edit Rent Properties</h5>
    </div>
    <form action="{{ route('rent-property-models.edited')}}" method="POST" class="rounded bg-white shadow p-5" enctype="multipart/form-data">
    @csrf
