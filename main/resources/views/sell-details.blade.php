...
@endif
<form action="{{route('sell-comment')}}" method="POST" class="rounded bg-white shadow p-5" >
    @csrf
...
<div class="rounded bg-white shadow p-5 ">
    ...
    <div class="flex d-flex flex-row ">
       ...
       <h6 ><button class="btn-sm btn-primary" type="submit"><a href={{"/viewBidder/".$bid->id}} class="text-white text-decoration-none">View</a></button></h6> 
    </div>
    @endforeach
    @else
    <h6>No bids yet</h6>
