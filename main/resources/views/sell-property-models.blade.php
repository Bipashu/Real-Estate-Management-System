...
<div class="container-lg">
    <div class="text-start">
        ...
        <a href="{{route('sell-property-models.create')}}"class="d-block mt-3 text-decoration-none lead">
            ...
            <img src="{{asset('images/'.$property->image)}}" width="300px" height="300px" class="card-img-top" alt="...">
                <div class="card-body text-start py-4">
                   ...
                   <div class="row">
                       ...
                       <a href={{"selledit/".$property->id}} class="text-decoration-none pe-2 border-end border-primary">Edit</a>
                       @endif
                      
                       <a href={{"selldetails/".$property->id}} class="text-decoration-none">Details</a>
                       </div>
                       <div class="col-6 text-end">
                       @if($property->property_status!='booked')
                       <a href={{"selldelete/".$property->id}}><i class="bi bi-x-square-fill fa-2x" style="color:#fa020b"></i></a>
                       @endif
                       </div>
                   </div>
