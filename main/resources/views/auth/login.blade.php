...
@section('content')
  ...
  @endif
            @if(session('status'))
               ...
               @endif
            <form action="{{ route('login') }}" method="POST" class="rounded bg-white shadow p-5">
               
            @csrf
                <h3 class="text-dark fw-bolder fs-4 mb-2 text-muted">Sign in to RPA</h3>
                <div class="fw-normal text-muted mb-4" >
                    New Here? <a href="/register" class=" fw-bold text-decoration-none" style="color:#E27D60;">Create an account</a>
                </div>
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}"class=" fw-bold text-decoration-none" style="color:#E27D60;">Forget Password?</a>
                    @endif
                </div>
                ...
                <a href="/agentlogin"class=" fw-bold text-decoration-none" style="color:#E27D60;">Login as Agent?</a>
                </div> 
