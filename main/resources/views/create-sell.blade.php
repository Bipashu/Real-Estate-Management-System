...
<div class="text-start">
        <h5 style="color:#E8A87C;">Register Sell Properties</h5>
    </div>
    <form action="{{route('sell-property-models.created')}}" method="POST" class="rounded bg-white shadow p-5"  enctype="multipart/form-data">
    @csrf
    <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-5 text-center text-md-start">
                   ...
                   <div class="form-floating mb-3">
                       <input type="file" class="form-control-file text-muted border border-white @error('image') is-invalid @enderror" id="floatingInput" name="image" >
                       @error('image')
                                       <span class="invalid-feedback" role="alert">
                                           <strong>{{ $message }}</strong>
                                       </span>
                                   @enderror
                       <label for="floatingInput" class="text-muted"></label>
                   </div>
                   <div class="form-floating mb-3">
