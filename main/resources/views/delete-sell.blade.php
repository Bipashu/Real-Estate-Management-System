...
<div class="text-start">
        <h5 style="color:#E8A87C;">Delete Sell Property</h5>
    </div>
    <form action="{{route('sell-property-models.deleted')}}" method="POST" class="rounded bg-white shadow p-5" enctype="multipart/form-data">
    @csrf
