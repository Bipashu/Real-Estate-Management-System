                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu text-white" aria-labelledby="navbarDarkDropdownMenuLink" style="background-color:#E8A87C">
                            ...
                            <li><a class="dropdown-item small text-white" href="{{route('your-property')}}" >Your Properties</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('rent-property-models')}}" class="nav-link">Manage Properties To Rent</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('sell-property-models')}}" class="nav-link">Manage Properties To Sell</a>
                    </li>
